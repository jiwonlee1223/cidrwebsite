...
export default function EringsPage() {
  ...
  const project = projectList.find((p) => p.slug === 'midas');
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-img">
          <Image
            ...
            onClick={() => setSelectedImage('/midas01.jpg')}
          />
          <Image
            src="/midas02.jpg"
            alt="e-rings"
            ...
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/midas02.jpg')}
          />
          <Image
            src="/midas03.jpg"
            alt="e-rings"
            ...
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/midas03.jpg')}
          />
        </div>
        <div className="half"></div>
      </div>
