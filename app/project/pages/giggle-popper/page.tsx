...
export default function ArecaPage() {
  ...
  const project = projectList.find((p) => p.slug === 'giggle-popper');
    ...
    <>
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-video">
          <iframe
            ...
            src="https://www.youtube.com/embed/3dgpeV753dM"
            title="YouTube video"
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-video">
          <iframe
            className="project-video"
            src="https://www.youtube.com/embed/VRZXq_FAkg8"
            title="YouTube video"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-video">
          <iframe
            className="project-video"
            src="https://www.youtube.com/embed/dm9Bbnc97As"
            title="YouTube video"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
