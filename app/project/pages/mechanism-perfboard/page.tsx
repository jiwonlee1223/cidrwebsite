...
export default function EringsPage() {
  ...
  const project = projectList.find((p) => p.slug === 'mechanism-perfboard');
  ...
  return (
    <>
      ...
      <div className="main-page-container">
        ...
        <div className="half">
          <span className="project-title-extra-small">{project.name}</span>
        </div>
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-img">
          <Image
            src="/mechanism-perfboard.png"
            alt="e-rings"
            width={800}
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/mechanism-perfboard.png')}
          />
        </div>
        <div className="half"></div>
      </div>
