...
export default function ArecaPage() {
  ...
  const project = projectList.find((p) => p.slug === 'automatastage');
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-img">
          <Image
            ...
            onClick={() => setSelectedImage('/automata01.png')}
          />
          <Image
            src="/automata02.jpg"
            alt="automata"
            ...
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/automata02.jpg')}
          />
          <Image
            src="/automata03.jpg"
            alt="automata"
            ...
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/automata03.jpg')}
          />
        </div>
        <div className="half"></div>
      </div>
      ...
      <div className='main-page-container'>
        ...
        <div className="halfthree-project-video">
          <iframe
            ...
            src="https://www.youtube.com/embed/mkn5Mh1pmeA"
            title="YouTube video"
