...
export default function MuzlogPage() {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);
  const project = projectList.find((p) => p.slug === 'muzlog');
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-img">
          <Image
            ...
            onClick={() => setSelectedImage('/muzlog01.jpg')}
          />
          <Image
            src="/muzlog02.jpg"
            alt="muzlog02"
            ...
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/muzlog02.jpg')}
          />
        </div>
        <div className="half"></div>
      </div>
