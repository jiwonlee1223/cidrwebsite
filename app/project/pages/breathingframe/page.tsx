...
export default function BreathingframePage() {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);
  const project = projectList.find((p) => p.slug === 'breathingframe');
    ...
    <>
      ...
      <div className="main-page-container">
        ...
        <div className="halfthree-project-img">
          <Image
            src="/breathingframe01.jpg"
            alt="bendi"
            width={800}
            height={600}
            className="project-img"
            onClick={() => setSelectedImage('/breathingframe01.jpg')}
          />
        </div>
        <div className="half"></div>
      </div>
